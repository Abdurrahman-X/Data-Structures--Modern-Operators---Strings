...
const checkDogs = function (dogsJulia, dogsKate) {
    ...
    allDogs.forEach((dog, i) => {
        ...
        const output = `Dog number ${i+1} is an ${dogType}, and is ${dog} years old`;
        
        if (dogType === 'adult') {
            console.log(output);
        } else {
            console.log(`Dog number ${i+1} is still a ${dogType}`);
        }
    });
    //console.log(dogsJulia, newDogsJulia, allDogs);
}
*/
...
// USING CHAINING & ARROW FUNCTIONS
...
// 8.
const dogsCopySorted = dogs.slice().sort((a, b) => a.recommendedFood - b.recommendedFood);
